...
JSResource.content_accessible_suffix="s";function trim(str) {
...
var ContentSummary = {
	...
	updateContent : function() {
		// update the skyscraper and text links for other languages then en. For en we use GAM		
		if(this.language!='en'){
			this.updateBanner();
			this.updateAds();
		}		
...
function doOnResult(text) {	
	if(text != "" && document.getElementById('rightbarcontentbox') != null) {
		// for en use GAM for the rest the old solution		
		if(ContentSummary.language=='en'){			
