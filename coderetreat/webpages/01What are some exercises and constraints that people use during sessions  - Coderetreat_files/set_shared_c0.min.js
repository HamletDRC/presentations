...
while(true){
var _9=s.replace(new RegExp("(<[^\\s]"+_7+")\\n+","g"),"$1 ");
if(s==_9){
break;
}
s=_9;
...
_f.find("input[value=_blank]").prop("checked","checked");
}else{
_f.find("input[value=_self]").prop("checked","checked");
}
},onOk:function(_10){
...
if(_1.layout){
_4.find("input[value="+_1.layout+"]").prop("checked","checked");
}
...
if(_a){
_4.find("input").removeAttr("disabled");
_4.removeClass("dy-disabled");
}else{
_4.find("input").prop("disabled","disabled");
_4.addClass("dy-disabled");
}
};
...
$submitButton=_1a.find("input[type=submit]");
if(_2e){
$submitButton.removeAttr("disabled").removeClass("dy-disabled");
}else{
$submitButton.prop("disabled","disabled").addClass("dy-disabled");
}
};
...
if(_5){
_3.find("input").removeAttr("disabled");
_3.removeClass("dy-disabled");
}else{
_3.find("input").prop("disabled","disabled");
_3.addClass("dy-disabled");
}
};
...
_f.setEnabled(_1d);
$submitButton=_12.find("input[type=submit]");
if(_1d){
$submitButton.removeAttr("disabled").removeClass("dy-disabled");
}else{
$submitButton.prop("disabled","disabled").addClass("dy-disabled");
...
tinyMCE.init({entity_encoding:"raw",verify_html:false,mode:"specific_textareas",plugins:"media,paste",editor_selector:"wysiwyg-mce-editor",language:null,relative_urls:false,gecko_spellcheck:true,theme:"advanced",theme_advanced_buttons1:"",theme_advanced_buttons2:"",theme_advanced_buttons3:"",theme_advanced_toolbar_align:"left",theme_advanced_toolbar_location:"top",theme_advanced_statusbar_location:"bottom",theme_advanced_path:false,theme_advanced_resizing:true,theme_advanced_resize_horizontal:false,theme_advanced_resizing_use_cookie:false,theme_advanced_fonts:_1,onpageload:function(){
_9=true;
},setup:_.setup,convert_urls:false,setupcontent_callback:_.afterSetup,extended_valid_elements:"*[*],script[charset|defer|language|src|type]",media_strict:false,forced_root_block:"p",cleanup_on_startup:false,trim_span_elements:false,remove_linebreaks:false,convert_fonts_to_spans:false,paste_preprocess:function(pl,o){
o.content=o.content.replace(/\r*\n/g," ");
if(x$.browser.msie){
o.content=o.content.replace(/<A href="[^"]+[<>][^"]+">(.*?)<\/A>/g,"$1").replace(/<A href='[^']+[<>][^']+'>(.*?)<\/A>/g,"$1");
}
},paste_auto_cleanup_on_paste:true});
_.ensureTinyMCEInitializedWhenDocumentReady();
};
_.setupRegularEditorOrFullScreenEditor=function(_d,_e){
_.setupDefaultFont(_d,_e);
_.monitorFileUploadCount(_d,_e);
_.setupIndentAndOutdent(_d,_e);
_.handlePastingEmbedCode(_d,_e);
_.setupJustifyCommands(_d,_e);
_.setupTinyAutoSave(_d,_e);
_e.onInit.add(function(){
_d.data("htmlCapability").configureAlignmentFormats(_e);
});
};
_.setupJustifyCommands=function(_f,_10){
var _11=function(_12){
_f.data("htmlCapability").beforeAlign(_10);
x$.each(["left","center","right","full"],function(i,_14){
if(_12!=_14){
_10.formatter.remove("align"+_14);
}
});
_10.formatter.toggle("align"+_12);
};
_10.addCommand("JustifyLeft",function(){
_11("left");
});
_10.addCommand("JustifyCenter",function(){
_11("center");
});
_10.addCommand("JustifyRight",function(){
_11("right");
});
};
_.setup=function(_15){
if(_15.id==="mce_fullscreen"){
_15.settings.theme_advanced_resize_horizontal=true;
return;
}
var _16=$(_15.getElement());
_16.data("width",_16.width());
_16.data("height",_16.height());
_16.data("htmlCapability").setupFontSizes(_15.settings);
if(_16.parent().hasClass("full-editor")){
_.addFullScreenPlugin(_16,_15);
}
_15.settings.theme_advanced_buttons1=_16.data("buttons");
_.preventSpuriousJqueryAttributes(_15);
_.setupRegularEditorOrFullScreenEditor(_16,_15);
_.addControls(_15,{add:new xg.shared.editors.tinymce.TinyMCELabel("add",{"text":xg.shared.nls.text("addColon")})});
_15.addButton("customlink",{title:xg.shared.nls.text("link"),"class":"mce_link",onclick:function(){
xg.shared.editors.tinymce.LinkDialog(_16).show();
}});
_15.addButton("customimage",{title:xg.shared.nls.text("image"),"class":"mce_image",onclick:function(){
xg.shared.editors.tinymce.ImageDialog(_16,null,xg.uploadsDisabled||_a.isMaxFileUploadCountReached(_16)).show();
}});
_15.addButton("custommedia",{title:xg.shared.nls.text("media"),"class":"mce_media",onclick:function(){
xg.shared.editors.tinymce.MediaDialog(_16).show();
}});
_15.addButton("custompastetext",{title:xg.shared.nls.text("pasteText"),"class":"mce_pastetext",onclick:function(){
xg.shared.editors.tinymce.PasteTextDialog(_16).show();
}});
_15.addButton("customfile",{title:xg.shared.nls.text("file"),"class":"mce_file",onclick:function(){
xg.shared.editors.tinymce.FileDialog(_16).show();
}});
_15.addButton("customcode",{title:xg.shared.nls.text("htmlEditor"),"class":"mce_code",onclick:function(){
_2(_16);
}});
_15.onPostRender.add(function(_17,_18){
_.addLinkToolbar(_16,_17);
_.addImageToolbar(_16,_17);
});
if(!_16.data("resized")){
_15.onLoadContent.add(function(_19,_1a){
var _1b=x$(_a.getEditor(_16).getContainer()).find("iframe").contents().find("body").height();
_1b=Math.max(_1b,x$(_a.getEditor(_16).getContainer()).find("iframe").height());
x$(_a.getEditor(_16).getContainer()).find("iframe").height(Math.min(_1b,600));
});
_16.data("resized",true);
}
};
_.setupTinyAutoSave=function(_1c,_1d){
var key=_1c.attr("_tinyAutoSaveKey");
if(!(x$.browser.msie&&parseInt(x$.browser.version,10)<=7)&&key){
_1d.settings.plugins+=",tinyautosave";
_1d.settings.tinyautosave_key=key;
_1d.settings.tinyautosave_showsaveprogress=false;
_1d.onPostRender.add(function(_1f,_20){
if(_1f.plugins.tinyautosave.hasSavedContent()){
...
e.preventDefault();
_1f.execCommand("mceTinyAutoSaveRestore");
});
x$(_1f.getContainer()).find(".mceStatusbar:first div:first").html($a);
}
});
}
};
_.preventSpuriousJqueryAttributes=function(_23){
_23.onGetContent.add(function(_24,o){
o.content=o.content.replace(/\s*jquery\d+="[^"]*"/g,"");
});
};
_.afterSetup=function(_26){
if(_26==="mce_fullscreen"){
return;
}
var _27=tinymce.getInstanceById(_26);
var _28=x$(_27.getElement());
setTimeout(function(){
_.fixIframeWidth(_28,_27);
_a.updateLiquidLayout(_28);
_a.updateBackgroundColor(_28,_27);
_.updateTinyMCEEditorHeight(_28,_27);
},0);
};
_.updateTinyMCEEditorHeight=function(_29,_2a){
x$(_2a.getContainer()).find("iframe").height(_29.data("height"));
};
_.fixIframeWidth=function(_2b,_2c){
var _2d=x$("iframe",_2c.getContainer());
if(_2b.data("width")&&(_2d.width()>20+_2b.data("width"))){
_2d.width(_2b.data("width"));
}
};
_.handlePastingEmbedCode=function(_2e,_2f){
_2f.onPaste.add(function(_30,_31){
setTimeout(function(){
var _32=_30.getContent();
if(_32.match(/&lt;(object|embed)/)){
_32=_32.replace(/&lt;object.*?&lt;\/object&gt;/g,_.decodeHtmlEntitiesInEmbedCode).replace(/&lt;embed.*?&lt;\/embed&gt;/g,_.decodeHtmlEntitiesInEmbedCode);
_30.setContent(_32);
}
},0);
});
};
_.decodeHtmlEntitiesInEmbedCode=function(_33){
_33=_33.replace(/<.*?>/g,"");
return tinymce.DOM.decode(_33);
};
_.addFullScreenPlugin=function(_34,_35){
_35.settings.plugins+=",fullscreen";
_35.onExecCommand.add(function(ed,_37){
if(_37!=="mceFullScreen"){
return;
}
x$("#mce_fullscreen_parent a.mce_fullscreen").attr("title",xg.shared.nls.text("returnToNormalSize"));
x$("#mce_fullscreen_toolbar1 .mceToolbarStart.mceFirst").after(x$("<td/>").append(_4(_34)));
var _38=tinymce.get("mce_fullscreen");
_.addLinkToolbar(_34,_38);
_.addImageToolbar(_34,_38);
_.setupRegularEditorOrFullScreenEditor(_34,_38);
});
};
_.addLinkToolbar=function(_39,_3a){
xg.shared.editors.tinymce.InlineToolbar({selector:"a:not(:has(img))",links:[{text:xg.shared.nls.text("edit"),onClick:function($a){
xg.shared.editors.tinymce.LinkDialog(_39,$a).show();
}},{text:xg.shared.nls.text("delete"),onClick:function($a){
_3a.dom.remove($a[0]);
_3a.undoManager.add();
_3a.getWin().focus();
}}],onShow:function($a,_3e){
var _3f=xg.shared.nls.text("linkColon")+" "+_.excerpt($a.attr("href"),_8);
_3e.find(".dy-content").prepend(xg.qh(_3f));
}}).addTo(_3a);
};
_.addImageToolbar=function(_40,_41){
xg.shared.editors.tinymce.InlineToolbar({selector:"img:not(.mceItemFlash)",links:[{text:xg.shared.nls.text("edit"),onClick:function(_42){
xg.shared.editors.tinymce.ImageDialog(_40,_42,xg.uploadsDisabled||_a.isMaxFileUploadCountReached(_40)).show();
}},{text:xg.shared.nls.text("delete"),onClick:function(_43){
if(_43.parent("a").length){
_41.dom.remove(_43.parent("a")[0]);
}else{
_41.dom.remove(_43[0]);
}
_41.undoManager.add();
_41.getWin().focus();
}}],onShow:function($a,_45){
var _46=xg.shared.nls.text("imageColon");
_45.find(".dy-content").prepend(xg.qh(_46)+" ");
}}).addTo(_41);
};
_.excerpt=function(_47,_48){
if(_47&&_47.length>_48){
return _47.substring(0,_48-1)+"\u2026";
}
return _47;
};
_.ensureTinyMCEInitializedWhenDocumentReady=function(){
x$(window.document).ready(function(){
if(!_9){
tinymce.dom.Event._pageInit(window);
tinymce.dom.Event._pageInit=function(){
};
}
});
};
_.addControls=function(_49,_4a){
_49.onBeforeRenderUI.add(function(_4b){
_4b.controlManager=new tinymce.ControlManager(_4b);
var _4c=_4b.controlManager.createControl;
_4b.controlManager.createControl=function(_4d){
return _4a[_4d]?_4a[_4d]:_4c.call(_4b.controlManager,_4d);
};
});
};
...
_.setupDefaultFont=function(_50,_51){
try{
var $p=x$("<p></p>").insertAfter(_50);
var _53="font-size: "+_50.attr("_fontSize")+" !important;";
if($p.css("font-family")){
_53+="font-family:"+$p.css("font-family")+" !important;";
}
$p.remove();
_51.onInit.add(function(){
x$(_51.getDoc()).find("head").append("<style type=\"text/css\">body, td, pre {"+_53+"} "+"p, ol, ul, dl, blockquote, table, h1, h2, h3, h4, h5, h6 { margin-bottom: "+_50.attr("_pMarginBottom")+"; } "+"p { margin-top: 0; }"+"</style>");
});
_51.onPostRender.add(function(_54,_55){
x$(_54.getContainer()).find(".mceColorPreview").css("background-color","#000000");
});
}
catch(e){
}
};
_.setupIndentAndOutdent=function(_56,_57){
_57.onKeyDown.add(function(_58,e){
$node=x$(_57.selection.getNode());
...
if(e.shiftKey){
_58.execCommand("Outdent");
}else{
_58.execCommand("Indent");
}
if(e.preventDefault){
e.preventDefault();
}
...
_.monitorFileUploadCount=function(_5a,_5b){
var _5c=xg.shared.util.createQuiescenceTimer(1000,function(){
_.checkFileUploadCount(_5a);
});
_5b.onKeyUp.add(_5c.trigger);
_5b.onPaste.add(_5c.trigger);
_5b.onChange.add(_5c.trigger);
_5b.onInit.add(function(){
_.checkFileUploadCount(_5a);
});
};
_.checkFileUploadCount=function(_5d){
var _5e=_a.isMaxFileUploadCountReached(_5d);
var _5f=_a.getEditor(_5d);
if(_5f){
_5f.controlManager.setDisabled("customfile",_5e);
if(_5e){
x$(_5f.getContainer()).find("a.icon-file").addClass("disabled");
}else{
x$(_5f.getContainer()).find("a.icon-file").removeClass("disabled");
}
}
_3(!_5e,_5d);
};
...
_4.find(".mceLayout").width(_5.width()+4);
}else{
...
if(!dojo.hostenv.findModule("xg.shared.topic",false)){
dojo.provide("xg.shared.topic");
xg.shared.topic={listeners:{},publish:function(_1,_2){
if(!this.listeners[_1]){
this.listeners[_1]=[];
}
dojo.lang.forEach(this.listeners[_1],function(_3){
_2=_2==null?[]:_2;
_3.apply(_3,_2);
});
...
this.listeners[_4].push(_5);
},unsubscribe:function(_6,_7){
if(!this.listeners[_6]){
this.listeners[_6]=[];
}
this.listeners[_6]=dojo.lang.filter(this.listeners[_6],function(_8){
return _7!==_8;
});
}};
}
...
xg.shared.topic.publish("xg.shared.editors.tinymce.TinyMCE.wysiwygEditorShown");
};
...
xg.shared.topic.publish("xg.shared.editors.tinymce.TinyMCE.htmlEditorShown");
};
...
xg.index.util.FormHelper.scrollIntoView(_1c);
return;
}
