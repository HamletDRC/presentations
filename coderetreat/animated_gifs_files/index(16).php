...
if (typeof(load_extratabs) == 'undefined' && typeof(extraTabs) == 'undefined') {
    ...
    var extraTabs = {
        ...
        global_add_image_tabs: function()
        {
            ...
            addPortletLink('p-cactions', '//' + tab_wikipedia + '.wikipedia.org/wiki/File:' + this.title, tab_wikipedia, 'ca-' + tab_wikipedia + 'wiki'); 
        },
        ...
        global_add_user_tabs: function(title)
        {
            ...
            addPortletLink('p-cactions', wgScript + '?title=' + this.tab_ns_special + 'ListFiles/' + username, tab_uploads, 'ca-uploads');
